...
/**
 * A UnifiedMessage represents a message in the format expected from the Unified
 * Push Server. The message format is very simple: A generic JSON map is used to
 * send messages to Android, iOS and Windows devices. The applications on the
 * devices will receive the JSON map and are responsible for performing a lookup
 * to read values of the given keys. See the <a
 * href="http://www.aerogear.org/docs/specs/aerogear-push-messages/">Message
 ...
 * {
 * 	&#064;code
 * 	UnifiedMessage unifiedMessage = UnifiedMessage.withMessage().alert(&quot;Hello&quot;)
 * 			.sound(&quot;default&quot;).criteria()
 * 			.variants(&quot;c3f0a94f-48de-4b77-a08e-68114460857e&quot;)
 * 			// e.g. HR_Premium
 * 			.aliases(&quot;mike&quot;, &quot;john&quot;).categories(&quot;sport&quot;, &quot;world cup&quot;)
 * 			.deviceType(&quot;iPad&quot;, &quot;AndroidTablet&quot;).build();
 * }
 * </pre>
 */
public class UnifiedMessage {
	 ...
	 *
	 * @deprecated Please use one of the static methods in
	 *             {@link UnifiedMessage}
	...
	public static class CriteriaBuilder {
		 ...
		 * 
		 * @param aliases
		 *            a list of "identifiers", like username or email address
		 * @return the current {@link CriteriaBuilder} instance
		 */
		...
		/**
		 * A filter for notifying only specific mobile variants of the Push
		 * Application.
		 * 
		 * @param variants
		 *            a list of mobile variants ids
		 * @return the current {@link CriteriaBuilder} instance
		 */
		 ...
		 * 
		 * @param deviceType
		 *            a list of devices i.e ["iPad","iPhone"]
		 * @return the current {@link CriteriaBuilder} instance
		 */
	...
	public static class MessageBuilder {
		 ...
		 * 
		 * @param message
		 *            that will be displayed on the alert UI element
		 * @return the current {@link MessageBuilder} instance
		 */
		...
		/**
		 * Plays a given sound - On iOS no API needs to be invoked to play the
		 * sound file. However on other platforms custom API call may be
		 * required.
		 * 
		 * @param sound
		 *            i.e name of the sound file
		 * @return the current {@link MessageBuilder} instance
		 */
		...
		/**
		 * Sets the value of the badge icon - no iOS API needs to be invoked by
		 * the app developer.
		 * 
		 * @param badge
		 *            i.e file name of the icon
		 * @return the current {@link MessageBuilder} instance
		 */
		 ...
		 * 
		 * @param version
		 *            to pass to the broadcast channel, i.e "version=5"
		 * @return the current {@link MessageBuilder} instance
		 */
		...
		/**
		 * Adds an custom value for the given key. This is used to pass user
		 * data to the UnifiedPush Server
		 *
		 * @param key
		 *            of an user data entry
		 * @param value
		 *            of an user data entry
		 * @return the current {@link MessageBuilder} instance
		 */
		...
		/**
		 * Adds a map containing custom key/value entries. This is used to pass
		 * user data to the UnifiedPush Server
		 * 
		 * @param userDataMap
		 *            containing custom key/value entries
		 * @return the current {@link MessageBuilder} instance
		 */
		...
		/**
		 * Windows specific push notification settings support for Tile, Raw,
		 * Badge and Toast messages For all the templates as much as possible
		 * the main parts of the message are re-used. Alert is the main text as
		 * is the badge number for badge notifications. Only specific windows
		 * settings are put in this part of the message and ignored by other
		 * message senders.
		 *
		...
		/**
		 * Apns specific push notification settings like "title",
		 * "actionCategory" ... <a href=
		...
		public static class WindowsBuilder {
			...
			/**
			 * Set the type of message to send toast, raw, badge or tile. <a
			 * href=
			 * "https://msdn.microsoft.com/en-us/library/windows/apps/hh465403.aspx"
			 * >more info about the types</a>
			 *
			 * @param type
			 *            of message to send
			...
			/**
			 * Set the raw notification type. A raw notification is a type of
			 * push notification without any associated UI. <a href=
			 * "https://msdn.microsoft.com/en-us/library/windows/apps/hh761463.aspx"
			 * >more info about the raw type</a>
			 *
			 * @return the current {@link WindowsBuilder} instance
			 */
			 ...
			 * >Tile and badge catalog</a>
			 *
			 * @param badgeType
			 *            the badge notifications type
			 * @return the current {@link WindowsBuilder} instance
			 */
			 ...
			 *
			 * @param durationType
			 *            the duration of a Toast message (long or short)
			 * @return the current {@link WindowsBuilder} instance
			 */
			...
			/**
			 * Set the toast template. Refer to the <a href=
			 * "https://msdn.microsoft.com/en-us/library/windows/apps/hh761494.aspx"
			 * >Toast template catalog</a>
			 *
			 * @param toastType
			 *            the toast template
			 * @return the current {@link WindowsBuilder} instance
			...
			/**
			 * Sets the page, this is a Windows specific setting that contains
			 * the page in you application to launch when the user 'touches' the
			 * notification in the notification dock. For cordova applications
			 * set this to 'cordova' to launch your app and invoke the
			 * javascript callback.
			 *
			 * Payload example:
			 * 
			 ...
			 * 
			 * @param page
			 *            to launch when user 'touches' the notification
			 * @return the current {@link WindowsBuilder} instance
			 */
		...
		public static class ApnsBuilder {
			...
			/**
			 * An iOS specific argument to mark the payload as
			 * 'content-available'. The feature is needed when sending
			 * notifications to Newsstand applications and submitting silent iOS
			 * notifications (iOS7)
			 *
			...
			/**
			 * An iOS specific argument to pass an Action Category for
			 * interaction notifications ( iOS8)
			 *
			 * @param actionCategory
			 *            the identifier of the action category for the
			 ...
			 *
			 * @param localizedTitleKey
			 *            the localized title key
			 * @return the current {@link ApnsBuilder} instance
			 */
			 ...
			 *
			 * @param localizedTitleArguments
			 *            the localized title arguments
			 * @return the current {@link ApnsBuilder} instance
			 */
			public ApnsBuilder localizedTitleArguments(
	...
	public static class ConfigBuilder {
		...
		/**
		 * Specify the Time To Live of the message, used by the APNs/GCM Push
		 * Networks. If the device is offline for a longer time than the ttl
		 * value, the supported Push Networks may not deliver the message to the
		 * client.
		 * 
		 * @param seconds
		 *            , the amount of seconds of the Time To Live
		 * @return the current {@link ConfigBuilder} instance
		 */
	...
	/**
	 * private constructor as UnifiedMessage can only be created through the
	 * Builder.
	 * 
	 * @param builder
	 *            The builder object that would be used to construct the
	 *            UnifiedMessage
	 */

...
/**
 * Thrown when sending the push delivery request fails due to invalid
 * credentials or Push Server error.
 */
public class PushSenderHttpException extends PushSenderException {
	...
	/**
	 * Constructs a new push sender runtime exception with the given http status
	 * code.
	 * 
	 * @param statusCode
	 */

...
public interface PushSender {
	...
	/**
	 * Sends the given payload to installations of the referenced
	 * PushApplication. We also pass a {@link MessageResponseCallback} to handle
	 * the message
	 * 
	 * @param unifiedMessage
	 *            the {@link UnifiedMessage} to send.
	 * @param callback
	 *            the {@link MessageResponseCallback}.
	 */
